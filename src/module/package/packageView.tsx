      ...
      <div className='container'>
        ...
        <div className='mt-10 grid grid-cols-1 lg:grid-cols-4 gap-4'>
          {listPackage?.map((item: any, index: number) => {
            return (
              <div key={index} className='border-1 p-5 rounded-lg border-gray-500 flex flex-col justify-center items-center duration-300 hover:-translate-y-2 hover:border-blue-500'>
                ...
                <div className='flex flex-col'>
                  {item.DetailPackage?.map((detail: any, detailIndex: number) => (
